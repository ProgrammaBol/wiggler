...
class AsteroidFragment(MovingSprite):
    ...
    def __init__(self,
        ...
        if self.size == 3:
            ...
            # self.costumes_defs["default"] = random.choice(
            #                              [("main", (292, 166, 18, 15),)
            self.costumes_defs["default"] = random.choice([
                ("extended", (117, 0, 30, 34)),
                ("extended", (151, 0, 32, 35))
            ])
        self.animations = {}
        ...
        super(AsteroidFragment, self).__init__(
            game_context,
            initdata=initdata,
...
class Asteroid(pygame.sprite.Group):
    ...
    def divide(self, child):
        for i in range(0, 2):
            ...
            fragment = self.spriteslib.get_sprite(AsteroidFragment,
                                                  self.game_context,
                                                  parent=self,
                                                  initdata=initdata)
            self.add(fragment)
